  ...
  return (
    <section className="firstSection" id="intro">
      <div className="leftSection">
        ...
        As a recent graduate, I've honed my skills through various projects and
        continuous learning and eager to embark on my professional journey in
        the tech industry. I am seeking an opportunity to contribute to a
        ...
        <i className="italic">front-end development space.</i>
      </div>
