    ...
    <div className="container" id="project">
      ...
      <section className="Projectfirstsection">
        <div className="ProjectleftSection">
          <p>
            <p>
              In daily operations related to farming or gardening watering is
            ...
            <p>
              To Improve Agricultural use of water in smart way reduce human
              work and to increase production this Automatic Plant Watering
              System is beneficial.
            </p>
            <p>
              This system involves several key components working together to
              monitor soil moisture level and activates a water pump when
              needed.
            </p>
          </p>
        </div>
